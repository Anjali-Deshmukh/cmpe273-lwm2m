...
import edu.sjsu.cmpe.objects.AccessControlObject;
...
import edu.sjsu.cmpe.observe.NotifyToServer;
import edu.sjsu.cmpe.observe.WriteAttribute;
...
public class DownlinkServer {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response OLDobserveRequest(@PathParam("objectId") int objectId,
			@PathParam("objectInstanceId") int objectInstanceId, @PathParam("resourceId") int resourceId,
